...
export default function ForgotPassword() {
  ...
  async function onSubmit(e){
    ...
    try{
      const auth = getAuth();
      //Функция предоставляемая firestore чтобы изменить пороль по почте
          ...
          <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
            <form action="" onSubmit={onSubmit}>
              ...
              <div className='flex justify-between flex-wrap text-sm sm:text-lg'>
                ...
                <p>
                  <Link to="/sign-in" className='text-blue-600 hover:text-blue-800 transition duration-200 ease-out'>Sign in instead</Link>
                </p>
              </div>
