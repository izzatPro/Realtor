...
export default function SignUp() {
  ...
  async function onSubmit(e){
    ...
    try {
      ...
      toast.success('Signed up was successed');
      navigate('/');
    } catch (error) {
        ...
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          ...
          <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
            <form onSubmit={onSubmit} >
              <input className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' type="text" id="name" value={name} onChange={(e) => onChange(e)} placeholder='Full Name'/>
              ...
              <div className='flex justify-between flex-wrap text-sm sm:text-lg'>
                <p className='mb-6'>Have an account?
                  <Link to="/sign-in" className='text-red-600 hover:text-red-700 transition duration-200 ease-out ml-3'>Sign In</Link>
                </p>
                <p>
